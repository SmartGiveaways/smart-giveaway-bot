        ...
        event.getChannel().sendMessage(
                new EmbedBuilder()
                        ...
                        .setDescription(this.langFor(server, Text.SCHEDULED_GIVEAWAY_INFO_EMBED_DESCRIPTION, replacer -> replacer
                                .set("uuid", giveaway.uuid())
                                .set("item", giveaway.giveawayItem())
                                .set("preset_name", giveaway.presetName())
                                .set("winner_amount", giveaway.winnerAmount())
                                .set("start_time", Time.formatAsDateTime(giveaway.startTime()) + " UTC")
                                .set("end_time", Time.formatAsDateTime(giveaway.endTime()) + " UTC")).get())
