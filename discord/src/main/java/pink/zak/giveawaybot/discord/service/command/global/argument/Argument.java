...
public class Argument<T> {
    ...
    /**
     * Creates an pink.zak.giveawaybot.argument for use with a SimpleCommand.
     *
     * @param type         The clazz type of the pink.zak.giveawaybot.argument, e.g a Player, OfflinePlayer, Integer or User.
     * @param argumentName The type of pink.zak.giveawaybot.argument (used in help), e.g player or amount.
     */
    ...
    /**
     * Creates an pink.zak.giveawaybot.argument for use with a SimpleCommand which has aliases.
     *
     * @param type         The clazz type of the pink.zak.giveawaybot.argument, e.g a Player, OfflinePlayer, Integer or User.
     * @param argumentName The type of pink.zak.giveawaybot.argument (used in help), e.g player or amount.
    ...
    /**
     * Gets the tester of the pink.zak.giveawaybot.argument
     */
    ...
    /**
     * Gets the pink.zak.giveawaybot.argument of the class.
     *
     * @return The pink.zak.giveawaybot.argument of the class, e.g "player" or "ban"
     */
